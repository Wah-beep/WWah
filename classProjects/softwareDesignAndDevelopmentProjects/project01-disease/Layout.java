public class Layout {
	...
	// x and y position of the labels for percent currently infected, percent recovered, percent not alive, as well as number of days
    static final int INFECTED_LABEL_X = 10;
    static final int INFECTED_LABEL_Y = 50;
    static final int RECOVERED_LABEL_X = 10;
    static final int RECOVERED_LABEL_Y = 100;
    static final int DECEASED_LABEL_X = 10;
    static final int DECEASED_LABEL_Y = 150;
    static final int DAYS_LABEL_X = 10;
    static final int DAYS_LABEL_Y = 200;
}