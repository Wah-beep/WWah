...
import student
import ga
from ga import fitness_function, next_gen  # Import fitness function and next_gen
...
# Pass all required arguments to solve()
ga.solve(students, courses, fitness_function, next_gen)
